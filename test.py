...
def test_send_tx(op_geth_url):
    raw_tx = "0x02f86d3f8245e4843b9aca008504a817c80082520894f07208ab3090856d8444f2682a6ecd12832a29446480c001a0fa37d322f5ccf859fd7a783535424f2447d24b2038f1d627ddb238a32f1f111ba065a9e298d1603e75ad01198d26c58024f694117781bc491357d64e7945bf3a96"
    payload = {
        "jsonrpc": "2.0",
    ...
    response = requests.post(op_geth_url, json=payload)
    return response.json()
...
# print(test_send_tx(op_geth_url2))
# print(test_send_tx("http://localhost:8090"))
